 ...
 * This file demonstrates how to integrate Forgezephyr with a web frontend
 */

// For React/Vue/Angular applications
export class ForgezephyrClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ForgezephyrClient(provider, contractAddress);
