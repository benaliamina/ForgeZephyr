...
const contractABI = require("../artifacts/contracts/Forgezephyr.sol/Forgezephyr.json").abi;

program
    .name("forgezephyr-cli")
    .description("CLI tool for Forgezephyr smart contract")
    .version("1.0.0");
